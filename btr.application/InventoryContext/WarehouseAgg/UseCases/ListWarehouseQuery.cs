...
public record ListWarehouseQuery() 
    : IRequest<IEnumerable<ListWarehouseResponse>>;
...
public class ListWarehouseHandler : IRequestHandler<ListWarehouseQuery,IEnumerable<ListWarehouseResponse>>
{
    ...
    public Task<IEnumerable<ListWarehouseResponse>> Handle(ListWarehouseQuery request, CancellationToken cancellationToken)
    {
        //  BUILD
