...
public record ListCustomerQuery() 
    : IRequest<IEnumerable<ListCustomerResponse>>;
...
public class ListCustomerHandler : IRequestHandler<ListCustomerQuery,IEnumerable<ListCustomerResponse>>
{
    ...
    public Task<IEnumerable<ListCustomerResponse>> Handle(ListCustomerQuery request, CancellationToken cancellationToken)
    {
        //  BUILD
